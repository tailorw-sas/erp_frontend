...
public enum DomainErrorMessage implements IDomainErrorMessage {
    ...
    EXISTS_SCHEDULE_SOME_DATE_WHOSE_TIME_RANGE(606, Series.DOMAIN_ERROR,
            "There exists a schedule on the same date, whose time range coincides at some moment with what you want to create."),
    EXISTS_SCHEDULE_WITH_DATE_STARTTIME_ENDTIME(607, Series.DOMAIN_ERROR,
            "There exists a schedule with the same date, start time, and end time."),
    SCHEDULE_NOT_FOUND(608, Series.DOMAIN_ERROR, "Schedule not found."),
    SCHEDULE_CANNOT_BE_EQUALS_STARTTIME_ENDTIME(609, Series.DOMAIN_ERROR,
    ...
    SCHEDULE_EXISTS_SOME_TIME_STARTTIME_EDNTIME(613, Series.DOMAIN_ERROR,
            "There exists a schedule with the same date, start time, and end time."),
    ...
    MANAGE_PAYMENT_SOURCE_NAME_CANNOT_BE_EMPTY(687, Series.DOMAIN_ERROR,
            "The name of the payment source cannot be empty."),
    ...
    MANAGER_MERCHANT_CURRENCY_MUST_BY_UNIQUE(688, Series.DOMAIN_ERROR,
            "Data entered overlaps with others, please check."),
    ...
    MANAGER_ACCOUNT_TYPE_NAME_CANNOT_BE_EMPTY(694, Series.DOMAIN_ERROR,
            "The name of the Manager Account Type cannot be empty."),
    ...
    MANAGE_PAYMENT_TRANSACTION_TYPE_NAME_CANNOT_BE_EMPTY(805, Series.DOMAIN_ERROR,
            "The name of the payment transaction type cannot be empty."),
    ...
    MANAGE_PAYMENT_TRANSACTION_TYPE_CHECK_DEFAULT(1013, Series.DOMAIN_ERROR,
            "Another item already exists with default."),
    CHECK_AMOUNT_GREATER_THAN_ZERO_STRICTLY(1014, Series.DOMAIN_ERROR,
            "The amount must be greater than zero and less or equal than Payment Balance."),
    CHECK_MINIMUM_CHARACTER_REQUIREMENT(1015, Series.DOMAIN_ERROR,
            "The comment does not meet the minimum character requirement."),
    CHECK_DATE_IS_BEFORE_CURRENT_DATE(1016, Series.DOMAIN_ERROR, "The provided date must be before the current date."),
    CHECK_PAYMENT_AMOUNT_GREATER_THAN_ZERO(1017, Series.DOMAIN_ERROR,
            "The entered payment amount is invalid. Please enter an amount strictly greater than zero."),
    CHECK_AMOUNT_IF_DEPOSIT_BALANCE_GREATER_THAN_ZERO(1018, Series.DOMAIN_ERROR,
            "Cannot create Apply Deposit payment details because the Deposit check transaction has insufficient balance."),
