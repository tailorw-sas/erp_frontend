...
public class ManageHotelPaymentStatusCodeMustBeUniqueRule extends BusinessRule {
    ...
    public ManageHotelPaymentStatusCodeMustBeUniqueRule(IManageHotelPaymentStatusService service,
                                                        String code, UUID id) {
        super(
