...
public class ManageMerchantCommissionFromDateAndToDateRule extends BusinessRule {

    private final LocalDate fromCheckDate; 

    private final LocalDate toCheckDate;

    public ManageMerchantCommissionFromDateAndToDateRule(LocalDate fromCheckDate, LocalDate toCheckDate) {
        super(
