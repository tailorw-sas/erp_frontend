...
public class TransactionInReconciliationRule extends BusinessRule {

    private final TransactionDto transactionDto;

    public TransactionInReconciliationRule(TransactionDto transactionDto) {
        super(
    ...
    public boolean isBroken() {
        return transactionDto.getReconciliation() != null;
    }
}
