package com.kynsoft.finamer.creditcard.infrastructure.utils;
...
@Component
public class CreditCardUploadAttachmentUtil {
    ...
    public CreditCardUploadAttachmentUtil(RestTemplate restTemplate) {
