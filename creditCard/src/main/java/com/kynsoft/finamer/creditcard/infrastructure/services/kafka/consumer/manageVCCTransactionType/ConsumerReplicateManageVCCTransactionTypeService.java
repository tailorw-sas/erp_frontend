...
public class ConsumerReplicateManageVCCTransactionTypeService {
    ...
    public void listen(ReplicateManageVCCTransactionTypeKafka entity) {
        try {
            CreateManageVCCTransactionTypeCommand command = new CreateManageVCCTransactionTypeCommand(entity.getId(), entity.getCode(), entity.getName(), entity.getIsDefault());
