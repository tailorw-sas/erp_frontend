package com.kynsoft.finamer.creditcard.infrastructure.services.kafka.consumer.manageB2BPartner;

import com.kynsof.share.core.domain.kafka.entity.ReplicateB2BPartnerKafka;
import com.kynsof.share.core.infrastructure.bus.IMediator;
import com.kynsoft.finamer.creditcard.application.command.manageB2BPartner.create.CreateManagerB2BPartnerCommand;
...
public class ConsumerReplicateB2BPartnerService {
    ...
    @KafkaListener(topics = "finamer-replicate-b2b-partner", groupId = "vcc-entity-replica")
    public void listen(ReplicateB2BPartnerKafka objKafka) {
        try {
            CreateManagerB2BPartnerCommand command1 = new CreateManagerB2BPartnerCommand(objKafka.getId(),objKafka.getCode(),objKafka.getDescription(),
                    objKafka.getName(),Status.valueOf(objKafka.getStatus()),"","","","","",objKafka.getB2BPartnerTypeDto());
