package com.kynsoft.finamer.creditcard.domain.rules.manageMerchantCommission;
...
public class ManageMerchantCommissionMustNotOverlapRule extends BusinessRule {
    ...
    public ManageMerchantCommissionMustNotOverlapRule(IManageMerchantCommissionService service, UUID id, UUID managerMerchant, UUID manageCreditCartType, LocalDate fromDate, LocalDate toDate, Double commission, CalculationType calculationType) {
        super(
