                                    ...
                                    <div class="flex align-items-center gap-2 px-0 py-0 ">
                                        ...
                                        <div class="w-full">
                                            <DebouncedAutoCompleteComponent v-if="!loadingSaveAll" id="autocomplete"
                                                :multiple=false field="name" item-value="id" class="w-full custom-input"
                                    ...
                                    <div class="flex align-items-center gap-2 px-0 py-0">
                                        ...
                                        <div class="w-full ">
                                            <DebouncedAutoCompleteComponent v-if="!loadingSaveAll"
                                                id="autocomplete-agency" multiple field="name" item-value="id"
                                                class="w-full agency-input" :model="filterToSearch.agency"
                                                :suggestions="agencyList" placeholder=""
                    ...
                    <div class="px-2 py-0 m-0 my-0 mt-0" style="flex: 1; padding: 16px;">
                        <div class="grid py-0 my-0 px-0" style="max-width: 1200px; margin: auto;">
                            ...
                            <div class="col-12 mb-0 py-0">
                                <div class="flex items-center w-full" style="flex-wrap: nowrap;">
                                    <!-- Usar flex para alinear en una fila -->
                                    <label for="client" class="font-bold mb-0 mr-1 mt-2 required"
                            ...
                            <div class="col-12 mb-0 ">
                                <div class="flex items-center w-full" style="flex-wrap: nowrap;">
                                    <!-- Usar flex para alinear en una fila -->
                                    <label for="credit" class="font-bold mb-0 ml-0 mt-2 "
                            ...
                            <div class="col-12 my-0 py-0 pb-0 xl:col-12 mb-2">
                                <div class="flex items-center w-full " style="flex-wrap: nowrap;">
                                    <!-- Usar flex para alinear en una fila -->
                                    <label for="language" class="font-bold mb-0 ml-3 mt-2"
                                    ...
                                    <div style="flex: 1; display: flex; gap: 8px; flex-wrap: nowrap;">
                                        ...
                                        <InputText id="timezone" v-model="currentTime" placeholder="Time Zone 12:10"
                ...
                <div class="col-12 flex align-items-center"> <!-- Usar flex para alinear en la misma fila -->
                    ...
                    <div
                        ...
                        <Button label="+More" style="height: 70%;text-decoration: underline;" severity="primary"
                            v-tooltip.left="'More'" class="mr-2 py-2 text-lg" @click=goToPayment() />
                    ...
                    <TabPanel>
                        ...
                        <div class="grid py-1 ">
                            <div class="col 12 xl:col-11 md:col-11 lg:col-11 ">
                                <DynamicTable :data="listItemsAgency" :columns="columnsAgency" :options="optionsAgency"
                ...
                <div class="col-12 flex align-items-center"> <!-- Usar flex para alinear en la misma fila -->
                    <div class="col-11 md:col-11 lg:col-11 xl:col-11 py-0 px-0">
                        <div class="card py-1 p-0 my-0">
                            <div class="header-content text-lg mr-0 font-bold"
                                style="background-color: var(--primary-color); color: white; padding: 8px; border-top-left-radius: 8px; border-top-right-radius: 8px;">
                                Invoice View
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <Button label="+More" style="height: 70%;text-decoration: underline;" severity="primary"
                            v-tooltip.left="'More'" class="mr-2 py-2 text-lg" @click=goToInvoice() />
                        <!-- Añadido margen derecho para separación -->
                    </div>
                </div>
            </div>
