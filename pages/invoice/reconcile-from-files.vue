...
<template>
                ...
                <template #expansion="slotProps">
                    <div class="p-0 m-0">
                        <DataTable :value="slotProps.data.rowExpandable" striped-rows>
                            <Column v-for="column of columnsExpandable" :key="column.field" :field="column.field"
    ...
    <Dialog v-model:visible="openSuccessDialog" modal class="mx-3 sm:mx-0 sm:w-full md:w-3"
