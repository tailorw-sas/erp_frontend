    ...
    <div class="bg-white" style="max-height: 100vh; height: 90vh">
        ...
        <div class="grid">
            <div class="col-12 order-0 w-full md:order-1 md:col-6  lg:col-6 xl:col-6">
                        ...
                        <div class="col-12 order-0  md:order-1 md:col-6 xl:col-3 lg:col-3 flex pb-0">
                            <div class="flex flex-column gap-2 w-full">
                                <div class="flex align-items-center gap-2">
                                    ...
                                    <div class="w-full">
                                        <Calendar v-model="filterToSearch.date" date-format="yy-mm-dd"
                ...
                <div v-if="openDialog">
                    <Dialog v-model:visible="openDialog" modal class="mx-3 sm:mx-0"
                        ...
                        <template #default>
                            <div class="p-2 pb-0">
                                ...
                                <div class="flex align-items-center mt-3 mb-2">
                                    ...
                                    <div>
                                        <InputText id="entry-code" v-model="entryCode" type="text"
