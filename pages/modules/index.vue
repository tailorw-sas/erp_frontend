...
const fields: Array<FieldDefinitionType> = [
  ...
  },
  {
    ...
    class: 'field col-12 required',
    headerClass: 'mb-1',
    validation: z.string().trim().min(1, 'The description field is required').max(250, 'Maximum 250 characters')
  },
  {
    field: 'status',
    header: 'Active',
...
async function getItemById(id: string) {
  if (id) {
    ...
    try {
      ...
      if (error) {
        toast.add({ severity: 'error', summary: 'Error', detail: 'Module could not be loaded', life: 3000 })
      }
    }
    finally {
