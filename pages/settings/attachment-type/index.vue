...
// TABLE OPTIONS -----------------------------------------------------------------------------------------
const options = ref({
  tableName: 'Manage Attachment Type',
  moduleApi: 'settings',
  uriApi: 'manage-attachment-type',
  loading: false,
  actionsAsMenu: false,
...
onMounted(() => {
  ...
  if (useRuntimeConfig().public.loadTableData) {
    getList()
    document.title = 'Manage Invoice Attachment Type'
  }
})
// -------------------------------------------------------------------------------------------------------
</script>
...
<template>
  <div class="flex justify-content-between align-items-center mb-1">
    <h5 class="mb-0">
      Manage Invoice Attachment Type
    </h5>
    <IfCan :perms="['ATTACHMENT-TYPE:CREATE']">
