...
const listLanguagesItems = ref<any[]>([])
...
async function getList() {
  ...
  try {
    ...
    for (const iterator of dataList) {
      if (Object.prototype.hasOwnProperty.call(iterator, 'language')) {
        iterator.language = iterator.language.name
      }
          ...
          >
            <template #field-language="{ item: data, onUpdate }">
              <DebouncedAutoCompleteComponent
                ...
                item-value="id"
                :model="data.language"
                :suggestions="listLanguagesItems"
                @change="($event) => onUpdate('language', $event)"
