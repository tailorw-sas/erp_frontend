  ...
  if (id) {
    ...
    try {
      ...
      if (response) {
        ...
        item.value.module = { id: response.moduleId, name: response.moduleName, status: 'ACTIVE' }
      }
...
async function createItem(item: { [key: string]: any }) {
  if (item) {
    ...
    payload.moduleId = item.module.id
    payload.moduleName = item.module.name
          ...
          >
            <template #field-module="{ item: data, onUpdate }">
              <DebouncedAutoCompleteComponent
                ...
                item-value="id"
                :model="data.module"
                :suggestions="listModuleItems"
                @change="($event) => onUpdate('module', $event)"
