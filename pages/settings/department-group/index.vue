...
const confApi = reactive({
  moduleApi: 'settings',
  uriApi: 'manage-department-group',
})
...
// TABLE OPTIONS -----------------------------------------------------------------------------------------
const options = ref({
  tableName: 'Manage Department Group',
  moduleApi: 'settings',
  uriApi: 'manage-department-group',
  loading: false,
  actionsAsMenu: false,
...
onMounted(() => {
  ...
  if (useRuntimeConfig().public.loadTableData) {
    getList()
    document.title = 'Manage Department Group'
  }
})
// -------------------------------------------------------------------------------------------------------
</script>
...
<template>
  <div class="flex justify-content-between align-items-center mb-1">
    <h5 class="mb-0">
      Manage Department Group
    </h5>
    <IfCan :perms="['DEPARTMENT-GROUP:CREATE']">
