...
// TABLE OPTIONS -----------------------------------------------------------------------------------------
const options = ref({
  tableName: 'Manage Room Category',
  moduleApi: 'settings',
  uriApi: 'manage-room-category',
  loading: false,
  actionsAsMenu: false,
...
onMounted(() => {
  ...
  if (useRuntimeConfig().public.loadTableData) {
    getList()
    document.title = 'Manage Room Category'
  }
})
// -------------------------------------------------------------------------------------------------------
</script>
...
<template>
  <div class="flex justify-content-between align-items-center mb-1">
    ...
    <IfCan :perms="['ROOM-CATEGORY:CREATE']">
