...
const fields: Array<FieldDefinitionType> = [
  {
    ...
    headerClass: 'mb-1',
    validation: z.string().trim().min(1, 'The code field is required').min(1, 'Minimum 1 character').max(10, 'Maximum 10 characters').regex(/^[a-z]+$/i, 'Only text characters allowed')
  },
  {
    field: 'name',
    header: 'Name',
...
const options = ref({
  ...
  loading: false,
  actionsAsMenu: false,
  messageToDelete: 'Are you sure you want to delete the Reconcile Transaction Status: {{name}}?'
})
...
onMounted(() => {
  ...
  if (useRuntimeConfig().public.loadTableData) {
    getList()
    document.title = 'Manage Reconcile Transaction Status'
  }
        ...
        <AccordionTab>
          ...
          <div class="flex gap-4 flex-column lg:flex-row">
            ...
            <div class="flex align-items-center">
              ...
              />
              <Button
                v-tooltip.top="'Clear'" :disabled="disabledClearSearch" outlined class="w-3rem" icon="pi pi-filter-slash" :loading="loadingSearch"
