...
const fields: Array<FieldDefinitionType> = [
  ...
  {
    field: 'enabledToPrint',
    header: 'Enabled To Print',
    dataType: 'check',
    class: 'field col-12 required mt-3',
  },
  {
    field: 'enabledToPropagate',
    header: 'Enabled To Propagate',
    dataType: 'check',
    class: 'field col-12 required',
  },
  {
    field: 'enabledToApply',
    header: 'Enabled To Apply',
    dataType: 'check',
    class: 'field col-12 required',
  },
  {
...
const item = ref<GenericObject>({
  ...
  code: '',
  status: true,
  enabledToPrint: false,
  enabledToPropagate: false,
  ...
  if (id) {
    ...
    try {
      ...
      if (response) {
        ...
        item.value.enabledToPrint = response.enabledToPrint
        item.value.enabledToPropagate = response.enabledToPropagate
...
onMounted(() => {
  ...
  if (useRuntimeConfig().public.loadTableData) {
    getList()
    document.title = 'Manage Invoice Status'
  }
          ...
          >
            ...
            <template #form-footer="props">
              <div class="flex justify-content-end">
                ...
                <IfCan :perms="['INVOICE-STATUS:DELETE']">
