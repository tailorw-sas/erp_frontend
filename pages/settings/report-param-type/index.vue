...
const confApi = reactive({
  moduleApi: 'settings',
  uriApi: 'manage-report-param-type',
})
...
const fields: Array<FieldDefinitionType> = [
  ...
  },
  {
    ...
    dataType: 'text',
    class: 'field col-12 required',
    validation: z.string().trim().min(1, 'The label field is required').max(50, 'Maximum 50 characters')
  },
  {
    field: 'hotel',
    header: 'Hotel',
...
const columns: IColumn[] = [
  ...
  { field: 'hotel', header: 'Hotel', type: 'bool' },
...
// TABLE OPTIONS -----------------------------------------------------------------------------------------
const options = ref({
  tableName: 'Manage Report Param Type',
  moduleApi: 'settings',
  uriApi: 'manage-report-param-type',
  loading: false,
  actionsAsMenu: false,
  ...
  if (id) {
    ...
    try {
      ...
      if (response) {
        ...
        item.value.source = response.source
...
<template>
  <div class="flex justify-content-between align-items-center mb-1">
    <h5 class="mb-0">
      Manage Report Param Type
    </h5>
    <IfCan :perms="['REPORT-PARAM-TYPE:CREATE']">
