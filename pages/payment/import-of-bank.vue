...
const columns: IColumn[] = [
  ...
  { field: 'bankAccount', header: 'Bank Acc.', tooltip: 'Bank Account', type: 'text' },
  { field: 'amount', header: 'Total Amount', type: 'text' },
  { field: 'transactionDate', header: 'Trans. Date', tooltip: 'Transaction Date', type: 'date' },
                ...
                <div class="w-full ">
                  <div class="p-inputgroup w-full">
                    ...
                    <span class="p-inputgroup-addon p-0 m-0">
                      <Button
                        icon="pi pi-file-import" severity="secondary" class="w-2rem h-2rem p-0 m-0" :disabled="loadingSaveAll"
