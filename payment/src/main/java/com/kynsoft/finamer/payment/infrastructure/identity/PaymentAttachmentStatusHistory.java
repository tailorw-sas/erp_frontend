...
public class PaymentAttachmentStatusHistory implements Serializable {
    ...
    public PaymentAttachmentStatusHistory(PaymentAttachmentStatusHistoryDto dto) {
        this.id = dto.getId();
    ...
    public PaymentAttachmentStatusHistoryDto toAggregate(){
        return new PaymentAttachmentStatusHistoryDto(
                id, 
                status, 
