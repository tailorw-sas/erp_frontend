package com.kynsoft.finamer.payment.infrastructure.services.kafka.consumer.templateEntity;

import com.kynsof.share.core.domain.kafka.entity.TemplateKafka;
import com.kynsof.share.core.infrastructure.bus.IMediator;
import com.kynsoft.finamer.payment.application.command.templateEntity.create.CreateTemplateEntityCommand;
...
public class ConsumerReplicateTemplateEntityService {
    ...
    @KafkaListener(topics = "finamer-replicate-template-entity", groupId = "payment-entity-replica")
