...
@Service(PaymentReportAllPaymentSupportService.BEAN_ID)
public class PaymentReportAllPaymentSupportService extends AbstractBasePaymentReportService {

    public static final String BEAN_ID = "ALL_SUPPORT";

    private final ReportContentProviderFactory reportContentProviderFactory;

    public PaymentReportAllPaymentSupportService(PaymentDataExtractorService dataExtractorService,
    ...
    protected List<byte[]> generateReportContents(UUID paymentId) {
        ...
        String reportCode = configuration.getReportCode(EPaymentReportType.ALL_SUPPORT);
