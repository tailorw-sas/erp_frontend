...
import BookingDialog from './BookingDialogForIncome.vue'
import BookingDialogForIncome from './BookingDialogForIncome.vue'
...
const columnsPaymentDetailsApplied = ref<IColumn[]>([
  ...
  { field: 'remark', header: 'Remark', type: 'text', width: '90px', maxWidth: '200px', sortable: true, showFilter: true },
])
