...
const emits = defineEmits<{
  (e: 'onSuccessClone', value: boolean): void
}>()
...
async function getItemById() {
  ...
  try {
    ...
    if (response) {
      ...
      item.value.phoneExtension = response.phoneExtension === '' ? '0' : response.phoneExtension
    }
        ...
        <div class="card p-4 m-0 pb-0 content-max-height">
          ...
          >
            ...
            <template #field-userType="{ item: data, onUpdate }">
              <div class="flex gap-4 justify-content-center mb-1">
                <div class="flex align-items-center">
                  <RadioButton
                    v-model="data.userType"
                    disabled input-id="internal" name="userType" value="INTERNAL" @change="($event) => {
                ...
                <div class="flex align-items-center">
                  <RadioButton
                    v-model="data.userType"
                    disabled input-id="external" name="userType" value="EXTERNAL" @change="($event) => {
