...
import com.kynsoft.finamer.settings.application.command.replicate.objects.CreateReplicateCommand;
import com.kynsoft.finamer.settings.application.command.replicate.objects.CreateReplicateMessage;
import com.kynsoft.finamer.settings.application.command.replicate.objects.CreateReplicateRequest;
