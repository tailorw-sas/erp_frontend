...
public class ManagerChargeTypeCodeMustBeUniqueRule extends BusinessRule {
    ...
    public ManagerChargeTypeCodeMustBeUniqueRule(IManagerChargeTypeService service, String code, UUID id) {
        super(
