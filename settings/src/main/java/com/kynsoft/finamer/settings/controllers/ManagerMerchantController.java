...
import com.kynsoft.finamer.settings.application.command.managerMerchant.create.CreateManagerMerchantCommand;
import com.kynsoft.finamer.settings.application.command.managerMerchant.create.CreateManagerMerchantMessage;
import com.kynsoft.finamer.settings.application.command.managerMerchant.create.CreateManagerMerchantRequest;
import com.kynsoft.finamer.settings.application.command.managerMerchant.delete.DeleteManagerMerchantCommand;
import com.kynsoft.finamer.settings.application.command.managerMerchant.delete.DeleteManagerMerchantMessage;
import com.kynsoft.finamer.settings.application.command.managerMerchant.update.UpdateManagerMerchantCommand;
import com.kynsoft.finamer.settings.application.command.managerMerchant.update.UpdateManagerMerchantMessage;
import com.kynsoft.finamer.settings.application.command.managerMerchant.update.UpdateManagerMerchantRequest;
