...
public class CreateManagePaymentStatusCommand implements ICommand {
    ...
    public CreateManagePaymentStatusCommand(final String code, final String name, final Status status, final Boolean collected, final String description) {
    ...
    public static CreateManagePaymentStatusCommand fromRequest(CreateManagePaymentStatusRequest request) {
        return new CreateManagePaymentStatusCommand(request.getCode(), request.getName(), request.getStatus(), request.getCollected(), request.getDescription());
    }
    @Override
