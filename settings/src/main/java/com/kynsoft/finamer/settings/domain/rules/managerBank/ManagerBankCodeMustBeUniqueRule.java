...
public class ManagerBankCodeMustBeUniqueRule extends BusinessRule {
    ...
    public ManagerBankCodeMustBeUniqueRule(IManagerBankService service, String code, UUID id) {
        super(
