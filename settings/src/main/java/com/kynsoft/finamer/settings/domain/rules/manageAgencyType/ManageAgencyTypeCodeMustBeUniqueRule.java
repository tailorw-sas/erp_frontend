...
public class ManageAgencyTypeCodeMustBeUniqueRule extends BusinessRule {
    ...
    public ManageAgencyTypeCodeMustBeUniqueRule(IManageAgencyTypeService service, String code, UUID id) {
        super(
