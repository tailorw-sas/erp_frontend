...
public class ManageClientCodeMustBeUniqueRule extends BusinessRule {
    ...
    public ManageClientCodeMustBeUniqueRule(IManagerClientService service, String code, UUID id) {
        super(
