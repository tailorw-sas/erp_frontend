...
public class UpdateManageTradingCompaniesCommandHandler implements ICommandHandler<UpdateManageTradingCompaniesCommand> {
    ...
    public UpdateManageTradingCompaniesCommandHandler(IManageTradingCompaniesService service, IManagerCountryService countryService, IManageCityStateService cityStateService) {
    ...
    public void handle(UpdateManageTradingCompaniesCommand command) {
        ...
        updateLong(dto::setCif, command.getCif(), dto.getCif(), update::setUpdate);
