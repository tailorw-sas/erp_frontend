...
public class ManagePaymentTransactionTypeDefaultMustBeUniqueRule extends BusinessRule {

    private final IManagePaymentTransactionTypeService service;

    private final UUID id;

    public ManagePaymentTransactionTypeDefaultMustBeUniqueRule(IManagePaymentTransactionTypeService service, UUID id) {
        super(
