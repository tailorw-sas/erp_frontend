...
public class ManageAgencyCodeMustBeUniqueRule extends BusinessRule {
    ...
    public ManageAgencyCodeMustBeUniqueRule(IManageAgencyService service, String code, UUID id) {
        super(
