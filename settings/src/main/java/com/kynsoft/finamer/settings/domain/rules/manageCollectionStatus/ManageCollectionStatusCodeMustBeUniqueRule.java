...
public class ManageCollectionStatusCodeMustBeUniqueRule extends BusinessRule {
    ...
    public ManageCollectionStatusCodeMustBeUniqueRule(IManageCollectionStatusService service, String code, UUID id) {
        super(
