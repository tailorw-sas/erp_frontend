...
import com.kynsoft.finamer.settings.application.query.objectResponse.*;
...
@Getter
@Setter
public class ManageAgencyListResponse implements IResponse, Serializable {
  ...
  //  private ManageCityStateResponse cityState;
    ...
    public ManageAgencyListResponse(ManageAgencyDto dto){
        this.id = dto.getId();
