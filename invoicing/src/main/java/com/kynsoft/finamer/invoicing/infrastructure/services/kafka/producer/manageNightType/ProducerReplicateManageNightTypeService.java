package com.kynsoft.finamer.invoicing.infrastructure.services.kafka.producer.manageNightType;
...
public class ProducerReplicateManageNightTypeService {
    ...
    public void create(ReplicateManageNightTypeKafka entity) {
        try {
            this.producer.send("finamer-invoice-replicate-manage-night-type", entity);
        } catch (Exception ex) {
