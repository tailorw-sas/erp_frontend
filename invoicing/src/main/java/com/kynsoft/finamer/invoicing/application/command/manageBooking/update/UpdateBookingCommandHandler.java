...
public class UpdateBookingCommandHandler implements ICommandHandler<UpdateBookingCommand> {
    ...
    public void handle(UpdateBookingCommand command) {
        ...
        UpdateIfNotNull.updateIfStringNotNullNotEmptyAndNotEquals(dto::setLastName, command.getLastName(),
        ...
        UpdateIfNotNull.updateIfStringNotNullNotEmptyAndNotEquals(dto::setCouponNumber, command.getCouponNumber(),
