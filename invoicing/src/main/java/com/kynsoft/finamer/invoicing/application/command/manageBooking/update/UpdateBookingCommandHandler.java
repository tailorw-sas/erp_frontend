...
public class UpdateBookingCommandHandler implements ICommandHandler<UpdateBookingCommand> {
        ...
        public void handle(UpdateBookingCommand command) {
                ...
                UpdateIfNotNull.updateLocalDateTime(dto::setBookingDate, command.getBookingDate(), dto.getBookingDate(),
                                update::setUpdate);
                UpdateIfNotNull.updateLocalDateTime(dto::setCheckIn, command.getCheckIn(), dto.getCheckIn(),
                                update::setUpdate);
                UpdateIfNotNull.updateLocalDateTime(dto::setCheckOut, command.getCheckOut(), dto.getCheckOut(),
                                update::setUpdate);
                UpdateIfNotNull.updateIfStringNotNullNotEmptyAndNotEquals(dto::setHotelBookingNumber,
                ...
                UpdateIfNotNull.updateDouble(dto::setInvoiceAmount, command.getInvoiceAmount(), dto.getInvoiceAmount(),
                                update::setUpdate);
                UpdateIfNotNull.updateIfStringNotNullNotEmptyAndNotEquals(dto::setRoomNumber, command.getRoomNumber(),
                                dto.getRoomNumber(), update::setUpdate);
                UpdateIfNotNull.updateIfStringNotNullNotEmptyAndNotEquals(dto::setCouponNumber,
                                command.getCouponNumber(),
                                dto.getCouponNumber(), update::setUpdate);
                UpdateIfNotNull.updateInteger(dto::setAdults, command.getAdults(), dto.getAdults(), update::setUpdate);
                UpdateIfNotNull.updateInteger(dto::setChildren, command.getChildren(), dto.getChildren(),
                                update::setUpdate);
                UpdateIfNotNull.updateDouble(dto::setRateAdult, command.getRateAdult(), dto.getRateAdult(),
                                update::setUpdate);
                UpdateIfNotNull.updateDouble(dto::setRateChild, command.getRateChild(), dto.getRateChild(),
                                update::setUpdate);
                UpdateIfNotNull.updateIfStringNotNullNotEmptyAndNotEquals(dto::setHotelInvoiceNumber,
                                command.getHotelInvoiceNumber(), dto.getHotelInvoiceNumber(), update::setUpdate);
                UpdateIfNotNull.updateIfStringNotNullNotEmptyAndNotEquals(dto::setFolioNumber, command.getFolioNumber(),
                                dto.getFolioNumber(), update::setUpdate);
                UpdateIfNotNull.updateDouble(dto::setHotelAmount, command.getHotelAmount(), dto.getHotelAmount(),
                                update::setUpdate);
                ...
                this.updateEntity(dto::setInvoice, command.getInvoice(),
                                dto.getInvoice() != null ? dto.getInvoice().getId() : null, update::setUpdate,
                                this.invoiceService::findById);
                this.updateEntity(dto::setRatePlan, command.getRatePlan(),
                                dto.getRatePlan() != null ? dto.getRatePlan().getId() : null, update::setUpdate,
                                this.ratePlanService::findById);
                this.updateEntity(dto::setNightType, command.getNightType(),
                                dto.getNightType() != null ? dto.getNightType().getId() : null, update::setUpdate,
                                this.nightTypeService::findById);
                this.updateEntity(dto::setRoomType, command.getRoomType(),
                                dto.getRoomType() != null ? dto.getRoomType().getId() : null, update::setUpdate,
                                this.roomTypeService::findById);
                this.updateEntity(dto::setRoomCategory, command.getRoomCategory(),
                                dto.getRoomCategory() != null ? dto.getRoomCategory().getId() : null, update::setUpdate,
