...
public class UpdateBookingCommandHandler implements ICommandHandler<UpdateBookingCommand> {
    ...
    public UpdateBookingCommandHandler(IManageBookingService bookingService, IManageInvoiceService invoiceService, IManageRatePlanService ratePlanService, IManageNightTypeService nightTypeService, IManageRoomTypeService roomTypeService, IManageRoomCategoryService roomCategoryService) {
    ...
    public void handle(UpdateBookingCommand command) {
        ...
        UpdateIfNotNull.updateInteger(dto::setHotelBookingNumber, command.getHotelBookingNumber(), dto.getHotelBookingNumber(), update::setUpdate);
        ...
        this.updateEntity(dto::setInvoice, command.getInvoice(), dto.getInvoice() != null ? dto.getInvoice().getId(): null, update::setUpdate, this.invoiceService::findById);
    ...
    private <T> void updateEntity(Consumer<T> setter, UUID newValue, UUID oldValue, Consumer<Integer> update, Function<UUID, T> findByIdFunction) {
