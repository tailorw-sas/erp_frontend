...
import com.kynsoft.finamer.invoicing.application.query.manageLanguage.search.GetSearchManagerLanguageQuery;
...
public class ManageLanguageController {
    ...
    public ManageLanguageController(IMediator mediator) {
