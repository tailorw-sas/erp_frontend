package com.kynsoft.finamer.invoicing.infrastructure.services.kafka.producer.manageBankAccount;

import com.kynsof.share.core.domain.kafka.entity.ReplicateManageBankAccountKafka;
import com.kynsof.share.core.infrastructure.bus.IMediator;
import com.kynsoft.finamer.invoicing.application.command.manageBankAccount.create.CreateManageBankAccountCommand;
    ...
    public void listen(ReplicateManageBankAccountKafka objKafka) {
        try {
            CreateManageBankAccountCommand command = new CreateManageBankAccountCommand(objKafka.getId(), objKafka.getAccountNumber(),
                    objKafka.getStatus(), objKafka.getNameOfBank(),objKafka.getManageHotel());
