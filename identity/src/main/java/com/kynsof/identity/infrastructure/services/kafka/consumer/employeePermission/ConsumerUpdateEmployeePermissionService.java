...
@Service
public class ConsumerUpdateEmployeePermissionService {

    private final IMediator mediator;
    private final IBusinessService businessService;
    private final IPermissionService permissionService;

    public ConsumerUpdateEmployeePermissionService(IMediator mediator,
    ...
    @KafkaListener(topics = "finamer-update-employee-permission", groupId = "identity-entity-replica")
    public void listen(UpdateEmployeePermissionKafka objKafka) {
        try {
            ...
            UserRoleBusinessUpdateRequest request = new UserRoleBusinessUpdateRequest();
            ...
            Logger.getLogger(ConsumerUpdateEmployeePermissionService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
