package com.kynsoft.finamer.insis.infrastructure.services.kafka.producer.manageRatePlan;
...
public class ProducerReplicateManageRatePlanService {
    ...
    public void create(ReplicateManageRatePlanKafka entity){
        try{
            producer.send("finamer-innsist-replicate-manage-rate-plan", entity);
        } catch (Exception ex) {
